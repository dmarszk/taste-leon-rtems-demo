...
#if 0
	printf("csp_conn_allocate 2\n\r");
#endif
	/* Search for free connection */
	i = csp_conn_last_given;
	i = (i + 1) % CSP_CONN_MAX;
#if 0
	printf("csp_conn_allocate: i= %d\n\r", i);
#endif
...
#if 0
	printf("csp_conn_allocate: csp_conn_last_given = %d\n\r", i);
#endif
	csp_bin_sem_post(&conn_lock);
